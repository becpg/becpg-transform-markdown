...
2. If you have suggestions, bug reports, or want to discuss improvements, open an [issue](https://github.com/becpg/becpg-transform-markdown/issues). We value all contributions and would love to hear from you.

## Submitting a Pull Request

1. [Fork](https://github.com/becpg/becpg-transform-markdown/fork) and clone the repository.
...
6. Push to your fork and [submit a pull request](https://github.com/becpg/becpg-transform-markdown/compare).
